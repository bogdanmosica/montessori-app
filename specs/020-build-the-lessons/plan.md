# Implementation Plan: Lessons Management

**Branch**: `020-build-the-lessons` | **Date**: October 5, 2025 | **Spec**: [spec.md]
**Input**: Feature specification from `/specs/020-build-the-lessons/spec.md`
...
**Storage**: PostgreSQL  
**Testing**: Skipped for initial rollout  
**Target Platform**: Web (Next.js)  
**Project Type**: web  
**Performance Goals**: <200ms p95 for lesson CRUD, support 100 concurrent users per school  
**Constraints**: RBAC, multi-tenant isolation, no hardcoded strings  
**Scale/Scope**: Up to 10,000 lessons per school, 100 schools
